...
`COMPOUND` file as described in [Experimental data files](../data/exp-data-files.html#exp-data-files). This compound file should be stored 
in the APFELcomb repository under the `compound` directory.

C-factors should be in the format once again specified in [Experimental data files](../data/exp-data-files.html#exp-data-files) and stored in the nnpdfcpp 
repository under
```
