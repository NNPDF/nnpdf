...
class Stat_Info:
    ...
    def __init__(self, vl_model, vl_data, ndata_dict, threshold_positivity = 1e-6,
            chi2_threshold = 3.0, save_all_each = 100, total_epochs = 0,
            stopping_epochs = 7000, dont_stop = False):
        """
