...
def generate_q2grid(Q0, Qfin, Q_points, match_dict, legacy40=False):
    ...
    # Otherwise dynamically create the grid from Q2_min --> Q2_max
        ...
        if Qfin is None and Q_points is None:
            ...
            raise ValueError("It is no longer possible to specify Qfin and Q_points")
        ...
        t_vals_ic = np.linspace(Q2_to_t(Q2_min), Q2_to_t((match_dict["mc"]*match_dict["kcThr"])**2), total_points_ic)
