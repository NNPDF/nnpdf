...
def _model_compilation(models, learning_rate, optimizer):
    ...
    for _, model_dict in models.items():
        ...
        model.compile(loss = losses, target_output=target, **param_dict)
...
class ModelTrainer:
    ...
    def _train_and_fit(self, training_model, stopping_object, epochs = 100, pos_multiplier = 1.0):
        ...
        Every 100 epochs the positivitiy will be updated with positivity_multiplier
        """
    ...
    def hyperparametizable(self, params):
        ...
        # Do some "preprocessing" of the hyperparameters
        ...
        # Only after the training has finished, we save all models
