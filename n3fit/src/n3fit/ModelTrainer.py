...
class ModelTrainer:
    ...
    def _train_and_fit(self, training_model, stopping_object, epochs=100):
        ...
        In the same way, every ``PUSH_INTEGRABILITY_EACH`` epochs the integrability will be multiplied by their
        respective integrability multipliers
        """
        ...
        for epoch in range(epochs):
            ...
            if (epoch + 1) % PUSH_INTEGRABILITY_EACH == 0:
                training_model.multiply_weights(
