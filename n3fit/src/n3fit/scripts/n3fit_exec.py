...
class N3FitConfig(Config):
    ...
    def from_yaml(cls, o, *args, **kwargs):
        ...
        if thconfig:=file_content.get('theorycovmatconfig') is not None:
            ...
            N3FIT_FIXED_CONFIG['use_user_uncertainties'] = thconfig.get('theorycovmatconfig').get('use_user_uncertainties')
            N3FIT_FIXED_CONFIG['use_scalevar_uncertainties'] = thconfig.get('theorycovmatconfig').get('use_scalevar_uncertainties')
