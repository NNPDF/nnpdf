...
def parse_times(timing_dictionary):
    """
        ...
        parses it to a string to be written to file

        The possible options are:
        {'start', 'replica_set', 'replica_fitted', 'data_loaded', 'end'}
...
def storefit(
    ...
    # Argument:
        ...
        - `timings`: string to write to file containing timing information of the fit
    """
    # build exportgrid
