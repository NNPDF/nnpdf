...
table = f"rawdata/HEPData-ins2771257-v2-Table_10.yaml"
...
def filter_ATLAS_Z1B_13TEV_PTZ_data_kinetic():
    ...
    with open("data_ATLAS_Z1C_13TEV_PTC.yaml", "w") as file:
        yaml.dump(data_central_yaml, file, sort_keys=False)

    with open("kinematics_ATLAS_Z1C_13TEV_PTC.yaml", "w") as file:
...
def filter_ATLAS_Z_13TEV_PT_uncertainties():
    ...
    with open("uncertainties_ATLAS_Z1C_13TEV_PTC.yaml", 'w') as file:
