...
import yaml
from filter_utils_CF import get_data_values, get_kinematics, get_systematics
from nnpdf_data.filter_utils.utils import prettify_float

yaml.add_representer(float, prettify_float)


def filter_ATLAS_Z0_7TEV_46FB_CF_data_kinematics():
    """
...
if __name__ == "__main__":
    filter_ATLAS_Z0_7TEV_46FB_CF_data_kinematics()
