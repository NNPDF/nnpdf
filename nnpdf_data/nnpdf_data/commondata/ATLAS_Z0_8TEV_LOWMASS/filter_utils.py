...
def get_kinematics():
    ...
    for indep_var1, indep_var2 in zip(input["independent_variables"][1]['values'], input["independent_variables"][2]['values']):

        kin_value = {
            'y': {'min': indep_var1['low'], 'mid': 0.5 * (indep_var1['low']+indep_var1['high']), 'max': indep_var1['high']},
            'M2': {
