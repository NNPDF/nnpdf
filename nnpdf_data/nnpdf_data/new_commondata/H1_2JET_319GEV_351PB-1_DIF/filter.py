from manual_impl import artunc, dijet_data, dijet_sys
import yaml
...
def processData():
    ...
    for i in range(len(values)):
        ...
        error_value = {}
        # error_value['stat'] = percentage_to_absolute(values[i]['errors'][0]['symerror'], data_central_value)
        # error_value['sys'] = percentage_to_absolute(values[i]['errors'][1]['symerror'], data_central_value)
    ...
    for i in range(len(values)):
        ...
        error_value = {}
        error_value['stat'] = percentage_to_absolute(
            values[i]['errors'][0]['symerror'], data_central_value
        )
        error_value['sys'] = percentage_to_absolute(
            values[i]['errors'][1]['symerror'], data_central_value
        )
