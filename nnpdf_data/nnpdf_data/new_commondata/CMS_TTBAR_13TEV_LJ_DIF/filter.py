...
def processData():
    ...
    artUncMat_dSig_dmttBar = covmat_to_artunc(ndata_dSig_dmttBar, covMatArray_dSig_dmttBar, 0)
    sqrts = 13000
    m_t2 = 29756.25
    ...
    error_definition_dSig_dmttBar['stat'] = {
        'definition': 'total statistical uncertainty',
        'treatment': 'ADD',
        'type': 'UNCORR',
    }
    error_definition_dSig_dmttBar['sys'] = {
    ...
    artUncMat_dSig_dmttBar_norm = covmat_to_artunc(
        ndata_dSig_dmttBar_norm, covMatArray_dSig_dmttBar_norm, 1
    )
    ...
    error_definition_dSig_dmttBar_norm['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
    ...
    artUncMat_dSig_dyttBar = covmat_to_artunc(ndata_dSig_dyttBar, covMatArray_dSig_dyttBar, 0)
    ...
    error_definition_dSig_dyttBar['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
    ...
    artUncMat_dSig_dyttBar_norm = covmat_to_artunc(
        ndata_dSig_dyttBar_norm, covMatArray_dSig_dyttBar_norm, 1
    )
    ...
    error_definition_dSig_dyttBar_norm['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
    ...
    artUncMat_d2Sig_dyttbar_dmttbar = covmat_to_artunc(
        ndata_d2Sig_dyttbar_dmttbar, covMatArray_d2Sig_dyttbar_dmttbar, 0
    )
    ...
    error_definition_d2Sig_dyttbar_dmttbar['stat'] = {
        'definition': 'total statistical uncertainty',
        'treatment': 'ADD',
        'type': 'UNCORR',
    }
    error_definition_d2Sig_dyttbar_dmttbar['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
    for i in range(ndata_d2Sig_dyttbar_dmttbar):
        error_definition_d2Sig_dyttbar_dmttbar['ArtUnc_' + str(i + 1)] = {
            'definition': 'artificial uncertainty ' + str(i + 1),
            'treatment': 'ADD',
            'type': 'CORR',
        }
    ...
    uncertainties_d2Sig_dyttbar_dmttbar_yaml = {
        'definitions': error_definition_d2Sig_dyttbar_dmttbar,
        'bins': error_d2Sig_dyttbar_dmttbar,
    }
    ...
    artUncMat_d2Sig_dyttbar_dmttbar_norm = covmat_to_artunc(
        ndata_d2Sig_dyttbar_dmttbar_norm, covMatArray_d2Sig_dyttbar_dmttbar_norm, 1
    )
    ...
    for i in tables_d2Sig_dyttBar_dmttBar_norm:
        ...
        for j in range(len(values)):
            ...
            for k in range(ndata_d2Sig_dyttbar_dmttbar_norm):
                error_value['ArtUnc_' + str(k + 1)] = float(
                    artUncMat_d2Sig_dyttbar_dmttbar_norm[j][k]
                )
            error_d2Sig_dyttbar_dmttbar_norm.append(error_value)

    error_definition_d2Sig_dyttbar_dmttbar_norm = {}
    error_definition_d2Sig_dyttbar_dmttbar_norm['stat'] = {
        'definition': 'total statistical uncertainty',
        'treatment': 'ADD',
        'type': 'UNCORR',
    }
    error_definition_d2Sig_dyttbar_dmttbar_norm['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
    for i in range(ndata_d2Sig_dyttbar_dmttbar_norm):
        error_definition_d2Sig_dyttbar_dmttbar_norm['ArtUnc_' + str(i + 1)] = {
            'definition': 'artificial uncertainty ' + str(i + 1),
            'treatment': 'ADD',
            'type': 'CORR',
        }

    data_central_d2Sig_dyttbar_dmttbar_norm_yaml = {
        'data_central': data_central_d2Sig_dyttbar_dmttbar_norm
    }
    ...
    uncertainties_d2Sig_dyttbar_dmttbar_norm_yaml = {
        'definitions': error_definition_d2Sig_dyttbar_dmttbar_norm,
        'bins': error_d2Sig_dyttbar_dmttbar_norm,
    }
    ...
    artUncMat_dSig_dpTt = covmat_to_artunc(ndata_dSig_dpTt, covMatArray_dSig_dpTt, 0)
    sqrts = 13000
    m_t2 = 29756.25
    values = input['dependent_variables'][0]['values']
    ...
    error_definition_dSig_dpTt['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
    ...
    artUncMat_dSig_dpTt_norm = covmat_to_artunc(ndata_dSig_dpTt_norm, covMatArray_dSig_dpTt_norm, 1)
    sqrts = 13000
    m_t2 = 29756.25
    values = input['dependent_variables'][0]['values']
    ...
    error_definition_dSig_dpTt_norm['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
    ...
    artUncMat_dSig_dyt = covmat_to_artunc(ndata_dSig_dyt, covMatArray_dSig_dyt, 0)
    sqrts = 13000
    m_t2 = 29756.25
    values = input['dependent_variables'][0]['values']
    ...
    artUncMat_dSig_dyt_norm = covmat_to_artunc(ndata_dSig_dyt_norm, covMatArray_dSig_dyt_norm, 1)
    sqrts = 13000
    m_t2 = 29756.25
    values = input['dependent_variables'][0]['values']
    ...
    error_definition_dSig_dyt_norm['sys'] = {
        'definition': 'total systematic uncertainty',
        'treatment': 'MULT',
        'type': 'CORR',
    }
