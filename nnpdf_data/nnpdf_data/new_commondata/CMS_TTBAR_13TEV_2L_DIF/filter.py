...
def processData():
    ...
    artunc_dSig_dpTt = covmat_to_artunc(6, covmat_dSig_dpTt, 0)
    ...
    artunc_dSig_dpTt_norm = covmat_to_artunc(5, covmat_dSig_dpTt_norm, 1)
    ...
    artunc_dSig_dmttBar = covmat_to_artunc(7, covmat_dSig_dmttBar, 0)
    ...
    artunc_dSig_dmttBar_norm = covmat_to_artunc(6, covmat_dSig_dmttBar_norm, 1)
    ...
    artunc_dSig_dyt = covmat_to_artunc(10, covmat_dSig_dyt, 0)
    ...
    artunc_dSig_dyt_norm = covmat_to_artunc(9, covmat_dSig_dyt_norm, 1)
    ...
    artunc_dSig_dyttBar = covmat_to_artunc(10, covmat_dSig_dyttBar, 0)
    ...
    artunc_dSig_dyttBar_norm = covmat_to_artunc(9, covmat_dSig_dyttBar_norm, 1)
