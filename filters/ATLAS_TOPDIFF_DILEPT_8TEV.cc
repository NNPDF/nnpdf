...
Measurements of normalized differential cross-sections of top quark pair (tt¯) production are presented as a function of the mass, the transverse momentum and the rapidity of the tt¯ system in proton-proton collisions at center-of-mass energies of s√ = 8 TeV. The dataset corresponds to an integrated luminosity of 20.2 fb−1 at 8 TeV, recorded with the ATLAS detector at the Large Hadron Collider. Events with top quark pair signatures are selected in the dilepton final state, requiring exactly two charged leptons and at least two jets with at least one of the jets identified as likely to contain a b-hadron. The measured distributions are corrected for detector effects and selection efficiency to cross-sections at the parton level.
...
2N) TABS 5, 17 HepData; TAB 5 in the paper
3N) TABS 6, 18 HepData; TAB 5 in the paper
1U) TABS 10, 22 HepData
2U) TABS 11, 23 HepData
3U) TABS 12, 24 HepData
