...
Combination of H1 and ZEUS measurements of open charm production reduced 
...
This data set supersedes HERAF2CHARM.
...
void HERACOMB_SIGMARED_CFilter::ReadData()
{
  //Opening file
  fstream f1;
  stringstream datafile("");
  datafile << dataPath() << "rawdata/"
	   << fSetName << "/d18-037.tableCharm.txt";
