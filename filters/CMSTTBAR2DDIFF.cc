...
void  CMSTTBAR2DDIFF8TEVTPTTRAPNORMFilter::ReadData()
{
  ...
  process_data("rawdata/CMSTTBAR2DDIFF8TEVTPTTRAP/CMSTTBAR2DDIFF8TEVTPTTRAP.data",
...
void  CMSTTBAR2DDIFF8TEVTTMTRAPNORMFilter::ReadData()
{
  ...
  process_data("rawdata/CMSTTBAR2DDIFF8TEVTTMTRAP/CMSTTBAR2DDIFF8TEVTPTTMTRAP.data",
...
void  CMSTTBAR2DDIFF8TEVTTMTTRAPNORMFilter::ReadData()
{
  ...
  process_data("rawdata/CMSTTBAR2DDIFF8TEVTTMTTRAP/CMSTTBAR2DDIFF8TEVTPTTMTTRAP.data",
...
void process_data(string data_filename, string cov_filename, string sys_filename)
{
  ...
  double new_systematics = fNSys-fNData
