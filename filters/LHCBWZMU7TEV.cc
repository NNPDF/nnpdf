...
void LHCBWZMU7TEVFilter::ReadData()
{
  ...
  datafile1 << dataPath() << "rawdata/" << fSetName << "/LHCBWZMU7TEV_wplrap.data";
  ...
  datafile2 << dataPath() << "rawdata/" << fSetName << "/LHCBWZMU7TEV_wmlrap.data";
  ...
  datafile2 << dataPath() << "rawdata/" << fSetName << "/LHCBWZMU7TEV_zrap.data";
  f2.open(datafile2.str().c_str(), ios::in);
  ...
  datafile3 << dataPath() << "rawdata/" << fSetName << "/LHCBWZMU7TEV_covmat.data";
