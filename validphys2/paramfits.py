...
def alphas_shift(datasepecs_as_value_error_table_impl,datasepecs_quad_table_impl,dataspecs_ndata_table,dataspecs_dataset_ndata,
        dataspecs_fits_as,dataspecs_speclabel,hide_total:bool=True,hideNAN:bool=False,ndata_weight:bool=True):
...
# Hiding experiments whose NNLO-NLO shift < 0.001 

    # df = df.loc[df.index != 'ATLAS1JET11']
    # df = df.loc[df.index != 'CHORUSNU'] 
    # df = df.loc[df.index != 'CDFZRAP'] 
    # df = df.loc[df.index != 'NMC']
    # df1 = df1.loc[df1.index != 'ATLAS1JET11']
    # df1 = df1.loc[df1.index != 'CHORUSNU'] 
    # df1 = df1.loc[df1.index != 'CDFZRAP']
    # df1 = df1.loc[df1.index != 'NMC']
    # df2 = df2.loc[df1.index != 'ATLAS1JET11']
    # df2 = df2.loc[df1.index != 'CDFZRAP']
    # df2 = df2.loc[df1.index != 'NMC']
    # df2 = df2.loc[df2.index != 'CHORUSNU'] 

# Hiding experiments with really bad determinations of alphas
    # df = df.loc[df.index != 'NTVNUDMN']
    # df = df.loc[df.index != 'CHORUSNB'] 
    # df = df.loc[df.index != 'CMSTOPDIFF8TEVTTRAPNORM'] 
    # df = df.loc[df.index != 'NMCPD']
    # df = df.loc[df.index != 'D0WEASY']
    # df = df.loc[df.index != 'ATLASZHIGHMASS49FB']
    # df1 = df1.loc[df1.index != 'NTVNUDMN']
    # df1 = df1.loc[df1.index != 'CHORUSNB'] 
    # df1 = df1.loc[df1.index != 'CMSTOPDIFF8TEVTTRAPNORM']
    # df1 = df1.loc[df1.index != 'NMCPD']
    # df1 = df1.loc[df1.index != 'D0WEASY']
    # df1 = df1.loc[df1.index != 'ATLASZHIGHMASS49FB']
    # df2 = df2.loc[df1.index != 'NTVNUDMN']
    # df2 = df2.loc[df1.index != 'CMSTOPDIFF8TEVTTRAPNORM']
    # df2 = df2.loc[df1.index != 'NMCPD']
    # df2 = df2.loc[df2.index != 'CHORUSNB']
    # df2 = df2.loc[df2.index != 'D0WEASY']
    # df2 = df2.loc[df2.index != 'ATLASZHIGHMASS49FB']
    ...
    print(nnlo_err,nlo_err)

    print(weighted_diff_nnlo,weighted_diff_nlo)
