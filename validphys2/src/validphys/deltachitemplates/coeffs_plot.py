...
parser.add_argument(
    "fitname",
    help="name of the fit. 1: NNPDF, 2: n3fit," " 3: feature scaling, 4: new feat. sc.",
    type=int,
    choices={1, 2, 3, 4},
)
...
for data in sorted_outfiles:
    ...
    nrep, a_N, b_N, c_N, d_N, err_a, err_b, err_c, err_d = np.loadtxt(
        out_dir + data.name, unpack=True
    )
