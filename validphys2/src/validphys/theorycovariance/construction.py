...
def compute_covs_pt_prescrip(point_prescription, name1, deltas1, name2=None, deltas2=None):
    ...
    elif point_prescription.startswith("alphas") or point_prescription.startswith("mtop"):
        # alphas and mtop variations are correlated for all datapoints and the
        # covmat construction is therefore equivalent to that of the
