...
void BCDMSD_dw_30Filter::ReadData()
{
  ...
  stringstream nuclearfile("");
  nuclearfile << dataPath() << "rawdata/BCDMSD/nuclear_30/output/tables/group_result_table.csv";
  f4.open(nuclearfile.str().c_str(), ios::in);
  ...
  stringstream protonfile("");
  protonfile << dataPath() << "rawdata/BCDMSD/proton_30/output/tables/group_result_table.csv";
  f5.open(protonfile.str().c_str(), ios::in);
  ...
  for (int i = 0; i < fNData; i++)
  {
    ...
    fSys[i][0].name = "BCDMSFB_30";
    fSys[i][0].type = ADD;
    fSys[i][1].name = "BCDMSFS_30";
    fSys[i][1].type = ADD;
    fSys[i][2].name = "BCDMSFR_30";
    fSys[i][2].type = ADD;
    
    fSys[i][3].mult = 3.0;   //normalisation uncertianty of 3%
    fSys[i][3].name = "BCDMSNORM_30";
    fSys[i][3].type = MULT;
    
    fSys[i][4].mult = -relnortarget;  //relative normalisation
    fSys[i][4].name = "BCDMSRELNORMTARGET_30";
    fSys[i][4].type = MULT;
...
void BCDMSD_sh_30Filter::ReadData()
{
  // Opening files
  fstream f1, f2, f3, f4, f5;
