...
def get_errors(
    ...
    stat, sys_uncorr, sys_uncorr_mult = [], [], []
    ...
    for idx in bin_index:
        ...
        sys_uncorr_mult.append(1.9 * central[idx] * 1e-2)

    sysdicts.update(
        {
            "stat": stat,
            "sys_uncorr": sys_uncorr,
            "sys_uncorr_mult": sys_uncorr_mult,
        }
    )
...
def dump_commondata(kinematics: list, data: list, errors: list) -> None:
    ...
    error_definition["sys_uncorr_mult"] = {
        "description": "Multiplicative Uncorrelated systematic uncertainties",
        "treatment": "MULT",
        "type": "UNCORR",
    }
...
def main_filter() -> None:
    ...
    4. Uncorrelated Systematic uncertainties: MULT, UNCORR
