...
Afer running evolven3fit, but before running posfit, this script should be run to set AlphaS_MZ and
MZ the .info file, to values listed in the theory database.
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fit_folder", required=True, help = f"Path to the folder containing the evolved fit")
    parser.add_argument("--theory_id", required=True, help = f"ID of the theory used to evolve the fit")
